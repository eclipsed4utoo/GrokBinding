...
namespace ApiDemoAndroid
{
  ...
  public class MyApp : Android.App.Application {
    ...
    public override void OnCreate()
    {
      ...
      Ugi.Singleton().LoggingStatus = Ugi.LoggingTypes.State | Ugi.LoggingTypes.InternalConnectionErrors | Ugi.LoggingTypes.InternalInventory;
  ...
  public class MainActivity : Activity, IUgiInventoryDelegate
  {
    ...
    void doStartStopInventory(object sender, EventArgs e) {
      ...
      if (tb.Checked) {
        ...
        FindViewById<Button> (Resource.Id.locateTagButton).Enabled = false;
    ...
    void tagListView_ItemClick(object sender, AdapterView.ItemClickEventArgs e) {
      ...
      FindViewById<Button> (Resource.Id.locateTagButton).Enabled = true;
    ...
    [Java.Interop.Export("doLocateTag")]
